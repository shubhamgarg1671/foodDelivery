...
public class RelatedProductAdapter extends RecyclerView.Adapter<RelatedProductAdapter.ProductViewHolder>
{
    ...
    public RelatedProductAdapter(Context mContext, ArrayList<Products> products, ProductAddInterface productAddInterface) {
    ...
    @NonNull
    @Override
    public RelatedProductAdapter.ProductViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.item_product, viewGroup, false);
        return new RelatedProductAdapter.ProductViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull final RelatedProductAdapter.ProductViewHolder productViewHolder, final int position) {
