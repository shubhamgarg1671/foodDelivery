...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.ProductViewHolder>
{
    ...
    public ProductAdapter(Context mContext, ArrayList<Products> products, ProductAddInterface productAddInterface) {
...
//                        session.setRestaurantMinAmt("100");
    ...
    public void CartAmt() {
        ...
        if (favouritesBeanSampleList != null) {
            ...
            if(sum>0.00)
            {
                SubCategoryActivity.tv_price.setText("Total Rs."+String.valueOf(sum));
                SubCategoryActivity.rv_proceed.setVisibility(View.VISIBLE);
            }
            else
                {
                    SubCategoryActivity.rv_proceed.setVisibility(View.GONE);
                }
        }
