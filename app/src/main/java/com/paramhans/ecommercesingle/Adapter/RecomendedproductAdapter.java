...
public class RecomendedproductAdapter extends RecyclerView.Adapter<RecomendedproductAdapter.ProductViewHolder>
{
    ...
    public RecomendedproductAdapter(Context mContext, ArrayList<Products> products, ProductAddInterface productAddInterface) {
    ...
    @NonNull
    @Override
    public RecomendedproductAdapter.ProductViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.item_recomended_products, viewGroup, false);
        return new RecomendedproductAdapter.ProductViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull final RecomendedproductAdapter.ProductViewHolder productViewHolder, final int position) {
        ...
        productViewHolder.card_view.setOnClickListener(new View.OnClickListener() {
            @Override
