...
public class PromocodeAdapter extends RecyclerView.Adapter<PromocodeAdapter.AddressViewHolder>
{
    private Context mContext;
    private ArrayList<PromoCode> promoCodes;
    PromocodeClick promocodeClick;

    public PromocodeAdapter(Context mContext, ArrayList<PromoCode> promoCodes, PromocodeClick promocodeClick) {
    ...
    @NonNull
    @Override
    public PromocodeAdapter.AddressViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.item_promocode, viewGroup, false);
        return new PromocodeAdapter.AddressViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull final PromocodeAdapter.AddressViewHolder viewHolder, final int position) {
