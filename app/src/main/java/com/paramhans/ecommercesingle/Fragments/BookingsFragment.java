...
public class BookingsFragment extends Fragment
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        home = v.findViewById(R.id.rel_booking_on);
    ...
    private void setBookings() {
        if (!CommonI.connectionAvailable(getActivity())) {
            ...
            JsonObjectRequest objectRequest = new JsonObjectRequest(Request.Method.POST, URLs.customer_ongoing_orderlist,
