...
public class FaqsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_about_us = findViewById(R.id.tv_faqs);
    ...
    private void setSellerDetails() {
        if (!CommonI.connectionAvailable(FaqsActivity.this)) {

        } else {

            viewDialog.showDialog();
            RequestQueue mRequestQueue = Volley.newRequestQueue(FaqsActivity.this);

            JsonObjectRequest objectRequest = new JsonObjectRequest(Request.Method.GET, URLs.faqs,
                ...
                public void onResponse(JSONObject response) {
                    ...
                    try {
                        if (response.getInt(JsonVariables.status) == 0) {
                            ...
                            CommonI.showSnackBar(FaqsActivity.this,
                                    container,
                            ...
                            viewDialog.hideDialog();
                            String about_us = response.getJSONObject(JsonVariables.data).getString("faqs");
